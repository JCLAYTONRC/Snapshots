...
class AddFragment : Fragment() {
    ...
    private fun postSnapshot() {
        ...
        if(mPhotoSelectedUri != null){
            storageRed.putFile(mPhotoSelectedUri!!)
                ...
                .addOnSuccessListener {
                    Snackbar.make(mBinding.root,"Foto publicada", Snackbar.LENGTH_SHORT)
                        .show()
                ...
                .addOnFailureListener{
                    Snackbar.make(mBinding.root,"No se pudo subir intente despues ", Snackbar.LENGTH_SHORT)
                        .show()
                }
