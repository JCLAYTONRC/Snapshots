...
class HomeFragment : Fragment(), HomeAux {
    ...
    private lateinit var mFirebaseAdapter: FirebaseRecyclerAdapter<Snapshot, SnapshoHolder>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mFirebaseAdapter = object : FirebaseRecyclerAdapter<Snapshot, SnapshoHolder>(option){
            ...
            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SnapshoHolder {
                ...
                return  SnapshoHolder(view)
            }

            override fun onBindViewHolder(holder: SnapshoHolder, position: Int, model: Snapshot) {
    ...
    inner class SnapshoHolder(view: View) : RecyclerView.ViewHolder(view){
